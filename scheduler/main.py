...
def main():
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--now":
        ...
        while True:
            ...
            launch_date = datetime.datetime.now().date() + datetime.timedelta(
                days=days_frequency
            )
            ...
            # set timestamp
            launch_timestamp = datetime.datetime.combine(launch_date, launch_time)
