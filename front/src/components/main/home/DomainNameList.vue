    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-">
        ...
        <select v-model="filterType" class="custom-select" id="dn-search-type">
          ...
          <option :value="filterTypeIP" selected>Filter by IP</option>
          <option :value="filterTypeDnTags" selected>
            Filter by domain name tags
          </option>
      ...
      <div class="form-group col-md-1">
        ...
        <router-link
          :to="`/?filter=${this.filter}&filterType=${this.filterType}&sortBy=${this.sortByType}&limit=${this.limit}&ownershipFilter=${this.ownershipFilter}`"
          type="button"
          id="dn-search"
