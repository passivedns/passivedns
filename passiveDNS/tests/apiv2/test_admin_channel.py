...
class AdminChannelTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.channel1 = Channel.new("channelTest1", "email", {
                                        "smtp_host":"test",
                                        "smtp_port":"test",
                                        "sender_email":"test",
        ...
        cls.channel2 = Channel.new("channelTest2", "email", {
                                        "smtp_host":"test2",
                                        "smtp_port":"test2",
                                        "sender_email":"test2",
...
#/admin/channels/{name} post
    def test_admin_create_channel(self) -> None:
        response = client.post("/admin/channels/test1", 
                              json={"type":"email", 
                                    "infos":{
                                        "smtp_host":"test",
                                        "smtp_port":"test",
    ...
    def test_admin_create_channel_already_exists(self) -> None:
        response = client.post("/admin/channels/_default", 
                              json={"type":"email", 
                                    "infos":{
                                        "smtp_host":"test",
                                        "smtp_port":"test",
    ...
    def test_admin_create_channel_parsing_error(self) -> None:
        response = client.post("/admin/channels/test3", 
                              json={"type":"email", 
                                    "infos":{
                                        "smtp_host":"test",
                                        "smtp_port":"test"
    ...
    def test_admin_create_channel_invalid_type(self) -> None:
        response = client.post("/admin/channels/test4", 
                              json={"type":"test", 
                                    "infos":{
                                        "smtp_host":"test",
                                        "smtp_port":"test",
...
#/admin/channels/{name} put
    def test_admin_update_channel(self) -> None:
        response = client.put("/admin/channels/channelTest1",
                              json={"type":"email", 
                                    "infos":{
                                        "smtp_host":"changed",
                                        "smtp_port":"changed",
    ...
    def test_admin_update_channel_not_found(self) -> None:
        response = client.put("/admin/channels/test5",
                              json={"type":"email", 
                                    "infos":{
                                        "smtp_host":"changed",
                                        "smtp_port":"changed",
