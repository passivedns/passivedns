...
class UserChannelTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.channel2 = Channel.new("channelTest1", "email", {
                                        "smtp_host":"test",
                                        "smtp_port":"test",
                                        "sender_email":"test",
        ...
        cls.channelUser2 = UserChannel.new("TestUser1", "channelTest1", "user1@test.com")
        cls.channelUser2.update(verified=True)
        cls.channelUser2.insert()

        #Test wrong token
        cls.channel3 = Channel.new("channelTest2", "email", {
                                        "smtp_host":"test",
                                        "smtp_port":"test",
                                        "sender_email":"test",
                                        "sender_password":"test"
        ...
        cls.channelUser3 = UserChannel.new("TestUser1", "channelTest2", "user1@test.com")
        cls.channelUser3.insert()

        #Test delete
        cls.channel4 = Channel.new("channelTest3", "email", {
                                        "smtp_host":"test",
                                        "smtp_port":"test",
                                        "sender_email":"test",
                                        "sender_password":"test"
        ...
        cls.channelUser4 = UserChannel.new("TestUser1", "channelTest3", "user1@test.com")
...
#/users/channels/{name} put
    def test_user_channel_verify(self) -> None:
        response = client.put("/user/channels/_default", json={"token":self.channelUser1.token})
        self.assertEqual(response.status_code, 200)
        self.assertIn("user_channel", response.json())
    
    def test_user_channel_verify_not_found(self) -> None:
        response = client.put("/user/channels/test", json={"token":self.channelUser1.token})
        self.assertEqual(response.status_code, 404)
    
    def test_user_channel_verify_already_verified(self) -> None:
        response = client.put("/user/channels/channelTest1", json={"token":self.channelUser1.token})
